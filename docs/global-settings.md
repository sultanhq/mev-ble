...
| 5 | `humidity_threshold` | 5 | UInt8, %RH | 0–100 | Sensor and response-mode semantics | Sensor control | Static; read-only |
...
| 21–22 | `co2_boost_threshold`, `co2_purge_threshold` | 22, 24 | UInt16LE value ÷ 10, ppm | 0–2000, step 10 | CO₂ model and threshold ordering | Sensor control | Static; read-only |
